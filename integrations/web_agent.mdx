...
<img 
  src="../images/integrations/web_agent/how_to_enable_cal.com.webp" 
...
Switch to the **Integrations** tab in the top navigation.
   ...
   <img 
  src="../images/integrations/web_agent/integrations.webp" 
...
/>
  ...
  <Step title="Enable the Web Agent">
   Locate the **Web Agent** card and toggle the switch to turn it on.
      <img 
  src="../images/integrations/web_agent/web_agent_connected.webp" 
...
/>
  ...
  <Step title="Click Configure Button">
   Once enabled, click the **Configure** button to open the settings modal.
         ...
         <img 
  src="../images/integrations/web_agent/configurations.webp" 
...
/>
  ...
  <Step title="Add Trusted Websites (Optional)">
    ...
    <img 
  src="../images/integrations/web_agent/add_trusted_websites.webp" 
  alt="Enabling Web Agent" 
     width="600"
    height="600"
  className="mx-auto rounded-xl border-4 border-blue-100 dark:border-blue-300"
