...
Botric’s agents are smart. They understand user intent from natural conversation. 
...
All tickets submitted through the chat agent are visible in your Botric dashboard under the **Tickets** section on the left sidebar. You can track and manage all support tickets from there.
