...
Go to your **Chat Agents** dashboard and click **View Agent** on the agent you’d like to update.

This will open the Integrations tab, as shown in the image below.

<img 
  src="../images/integrations/cal.com/connect.png" 
...
<Steps>
  <Step title="First Step:">
   ...
   <img 
  src="../images/integrations/cal.com/event_url.png" 
...
/>
  ...
  <Step title="Second Step:">
   Paste your Cal.com booking URL in the input field.
      <img 
  src="../images/integrations/cal.com/Connecting_URL.png" 
  alt="Connecting Booking Event URL" 
  className="rounded-xl border-4 border-blue-100 dark:border-blue-300"
/>
...
You’ll see a field where you can enter your personal or team Cal.com booking link for example:`https://cal.com/yourname/demo-call`
  ...
  <Step title="Third Step:">
   Click **Connect** to link your Cal.com account with the AI agent.
         ...
         <img 
  src="../images/integrations/cal.com/Booking_connected.png" 
...
<video
  ...
  muted
  playsInline
  className="w-full aspect-video rounded-xl border-4 border-blue-100 dark:border-blue-300"
  src="../images/integrations/cal.com/Botric_cal_integration.mp4"
></video>
